...
exports.updateProfile = async (req, res) => {
  try {
    ...
    // update profile - note the field 'number' in Profile model matches with 'contactNumber' in request
    profileDetails.dateOfBirth = dateOfBirth;
    profileDetails.about = about;
    profileDetails.gender = gender;
    profileDetails.contactNumber = contactNumber; // Changed from contactNumber to number to match model
...
// Fixed updateDisplayPicture function
exports.updateDisplayPicture = async (req, res) => {
  try {
    ...
    res.status(200).json({
      success: true,
      message: "Image updated successfully once again",
      data: updatedProfile,
    });
  } catch (error) {
    ...
    return res.status(500).json({
      success: false,
      message: "Couldn't update display picture, please try again",
      error: error.message,
    });
  }
};
...
exports.updateDisplayPicture = async (req, res) => {
  try {
    ...
    res.send({
      success: true,
      message: `Image Updated successfully display picture`,
      data: updatedProfile,
    })
  } catch (error) {
    return res.status(500).json({
